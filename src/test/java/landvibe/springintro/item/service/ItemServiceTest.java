...
// given
        Item item = createItem("눈을감자", 10, 1000); // when
...
// given
        ...
        Item duplicatedItem = createItem("눈을감자", 10, 1000); service.create(item);
// when & then
        IllegalArgumentException ex =
                assertThrows(IllegalArgumentException.class,
                        () -> service.create(duplicatedItem));// 예외 발생 assertThat(ex.getMessage()).isEqualTo("이미 존재하는 상품입니다.");
    }
